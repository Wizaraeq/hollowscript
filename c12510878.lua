...
function c12510878.spfilter(c,tp)
	return c:IsCode(18036057) and Duel.GetMZoneCount(tp,c)>0 and (c:IsFaceup() or c:IsControler(tp))
end
function c12510878.spcon(e,c)
	if c==nil then return true end
	return Duel.CheckReleaseGroup(c:GetControler(),c12510878.spfilter,1,nil,c:GetControler())
end
function c12510878.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(c:GetControler(),c12510878.spfilter,1,1,nil,tp)
