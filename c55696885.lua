...
function c55696885.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return true end
	c:RegisterFlagEffect(55696885,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
